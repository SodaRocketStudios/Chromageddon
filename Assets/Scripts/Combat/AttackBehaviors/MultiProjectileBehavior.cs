...
{
	[CreateAssetMenu(fileName = " New Multi-Projectile Behavior", menuName = "Combat/Attack Behavior/Multi-Projectile Behavior")]
	public class MultiProjectileBehavior : AttackBehavior
	{
