...
public partial class @ControlsProto: IInputActionCollection2, IDisposable
{
    ...
    private List<IAvatarControlsActions> m_AvatarControlsActionsCallbackInterfaces = new List<IAvatarControlsActions>();
    ...
    public struct AvatarControlsActions
    {
        ...
        public void AddCallbacks(IAvatarControlsActions instance)
        {
            if (instance == null || m_Wrapper.m_AvatarControlsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_AvatarControlsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IAvatarControlsActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(IAvatarControlsActions instance)
        {
            if (m_Wrapper.m_AvatarControlsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IAvatarControlsActions instance)
        {
            foreach (var item in m_Wrapper.m_AvatarControlsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_AvatarControlsActionsCallbackInterfaces.Clear();
